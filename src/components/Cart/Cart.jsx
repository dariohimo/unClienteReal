  ...
  return (
    ...
    <div className={styles.cartContainer}>
      ...
      {cartItems && cartOpen && (
        ...
        <div  >
         <img className={styles.logocartSoypanela} src="https://soypanela.com/wp-content/uploads/2020/02/cropped-LOGOTIPOS-WEB-02_Mesa-de-trabajo-1-7.png"  alt="Logo SoyPanela" />
       </div>
          <h2 className={styles.soypanela}> </h2> {/*logo carrito*/}

          {cartItems.length === 0 ? (

            <p className={styles.cartVacio}> Pedido de Café y Panela</p>
          ) : (
          ...
          <h3 className={styles.total}>Producto: {productsLength} Total: ${total}</h3>
         
          <div  className={styles.pedido}>
           
 
            <a  className={styles.whatsapp} target="blank"  href={`https://api.whatsapp.com/send?phone=578018015608&text= Cantidad  ${productsLength}  Total $${total}  `}> Enviar Pedido </a>
